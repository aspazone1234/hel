...
const VENUE_SLIDES = [
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/v5knbk6g_slider1.webp`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/jdcu5naw_unnamed.webp`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/ltq1jor4_unnamed.jpg`,
];

const FAMILY_CAROUSEL_IMAGES = [
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/2vr3eygd_1.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/d5pr1j11_2.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/49zwq0zu_3.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/q1zzskl6_4.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/o79880ks_5.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/h78gucz8_6.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/gspdfwm1_7.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/1mzm22ht_8.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/10rkt85o_9.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/uoxmc1xz_10.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/5gf61vsr_11.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/v38f20fo_12.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/4zvcz949_13.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/oxjr7h8r_14.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/cf33x059_15.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/60dn4leu_16.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/efz2s19s_17.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/b4i78wlv_18.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/crzlohu2_19.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/klhv2xsc_20.png`,
  `${process.env.REACT_APP_BACKEND_URL}/api/static/media/8u6ru495_21.png`,
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-6 mb-6 text-[#F8F1E5]/40 text-sm">
            ...
            <Link to="/privacy-policy" className="hover:text-[#D4AF37] transition-colors" data-testid="footer-privacy-link">Privacy Policy</Link>
          </div>
