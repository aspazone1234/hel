...
const STATIC_REFERENCE_PERSONS = [
  { id: "rp-bhawarlal", name: "Late Shri Bhawarlal ji Panchariya", rank: 0, relation_categories: [] },
  { id: "rp-ramswaroop", name: "Late Shri Ramswaroop Ji Panchariya", rank: 1,
    relation_categories: ["Business Associates", "Friends", "Sasural Side", "Neighbors", "Other Relatives", "Other"] },
  { id: "rp-satish", name: "Shri Satish Panchariya", rank: 2,
    relation_categories: ["Business Associates", "Friends", "Sasural Side", "Neighbors", "Other Relatives", "Other", "Samdhi"] },
  { id: "rp-arun", name: "Shri Arun Panchariya", rank: 3,
    relation_categories: ["Business Associates", "Friends", "Sasural Side", "Neighbors", "Other Relatives", "Other"] },
  { id: "rp-ashok", name: "Shri Ashok Panchariya", rank: 4,
    relation_categories: ["Business Associates", "Friends", "Sasural Side", "Neighbors", "Other Relatives", "Other"] },
  { id: "rp-alka", name: "Alka Jiji", rank: 5,
    relation_categories: ["Samdhi", "Other Relatives", "Other", "Sasural Side"] },
  { id: "rp-ratni",  name: "Late Shrimati Ratni Bai Ji Panchariya",   rank: 6,  relation_categories: [] },
  { id: "rp-babulal",name: "Late Shri Babulal Ji Panchariya",         rank: 7,  relation_categories: [] },
  { id: "rp-sugand", name: "Late Shri Sugandchand Ji Panchariya",     rank: 8,  relation_categories: [] },
  { id: "rp-sugni",  name: "Late Shrimati Sugni Bai Ji Panchariya",   rank: 9,  relation_categories: [] },
  { id: "rp-nand",   name: "Shri Nandkishor Ji Panchariya",           rank: 10, relation_categories: [] },
  { id: "rp-anandi", name: "Shrimati Anandibai Ji Panchariya",        rank: 11, relation_categories: [] },
  { id: "rp-shyam",  name: "Late Shri Shyam Ji Panchariya",           rank: 12, relation_categories: [] },
  { id: "rp-jaina",  name: "Late Shri Jainanarayan Ji Panchariya",    rank: 13, relation_categories: [] },
  { id: "rp-madan",  name: "Late Shri Madanlal Ji Panchariya",        rank: 14, relation_categories: [] },
  { id: "rp-ramk",   name: "Late Shri Ramkishan Ji Panchariya",       rank: 15, relation_categories: [] },
          ...
          <div className="space-y-6" data-testid="demo2-step-reference">
            ...
            <div>
              ...
              <Select value={referencePersonId} onValueChange={v => { setReferencePersonId(v); setRelationCategory(""); }}>
                ...
                <SelectContent>
                  {STATIC_REFERENCE_PERSONS.map(p => <SelectItem key={p.id} value={p.id}>{p.name}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
